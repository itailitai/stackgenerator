(() => {
  ...
  function adjustLine(from, to, line, trafo) {
    ...
    // line.parentElement.querySelector("p").style.position = "absolute";
    // line.parentElement.querySelector("p").style.top =
    //   line.offsetTop - 80 + "px";
    // line.parentElement.querySelector("p").style.left =
    //   line.offsetLeft + 70 + "px";
    line.parentElement.querySelector("p").style.position = "absolute";
    line.parentElement.querySelector("p").style["-webkit-transform"] =
      "rotate(" + ANG + "deg)";
    line.parentElement.querySelector("p").style["-moz-transform"] =
      "rotate(" + ANG + "deg)";
    line.parentElement.querySelector("p").style["-ms-transform"] =
      "rotate(" + ANG + "deg)";
    line.parentElement.querySelector("p").style["-o-transform"] =
      "rotate(" + ANG + "deg)";
    line.parentElement.querySelector("p").style["-transform"] =
      "rotate(" + ANG + "deg)";
    line.parentElement.querySelector("p").style.top = top + "px";
    line.parentElement.querySelector("p").style.left = left + 50 + "px";
    line.parentElement.querySelector("p").style.width = H + "px";
    line.parentElement.querySelector("p").style.height = W + "px";
  }
